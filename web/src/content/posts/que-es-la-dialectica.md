...
Ello quiere decir, que la dialéctica es esa forma de pensar, de articular el pensamiento que intenta explicar el objeto de su pensamiento en auto-movimiento, es decir, rompiendo con el paradigma de la mecánica clásica donde A determina (explica) a B. Para evitar malos entendidos [popperianos](https://es.wikipedia.org/wiki/Karl_Popper) sobre esa idea, pongo el ejemplo de El Capital, donde Marx, para poder explicar la situación de la clase obrera, tuvo que plantearse un objeto de estudio mayor, el modo capitalista de producir, y explicar a este, como sistema en auto-movimiento.
