...
Habrá que darles a los reguetoneros un sentido con el cual se puedan defender como artistas, y no solo eso, sino también como exponentes de una nueva vanguardia artística. Una vanguardia que retoma los preceptos [_Dadá_](https://es.wikipedia.org/wiki/Dada%C3%ADsmo) y _neo-Dadá_, a la vez que entabla un diálogo con el público, para lo cual utilizan una estética _Pop_ y _consumista_.
