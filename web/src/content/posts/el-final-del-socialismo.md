...
Si analizamos los procesos de socialización ocurridos en las experiencias del “socialismo real” y derivados (Cuba incluida), la cooperación ocurrida entre los trabajadores asalariados seguía siendo efecto de un agente efectivamente externos a ellos (la empresa estatal, las [OSDE](https://www.minag.gob.cu/node/6), los entes planificadores, etc.) que los empleaba simultáneamente, por lo que su unidad como cuerpo productivo les fue siempre ajena.
