...
El autor por excelencia de dicha cuestión del poder, es el espléndido [Michael Foucault](https://es.wikipedia.org/wiki/Michel_Foucault). Sin embargo, por otro lado, se cuenta con la figura de Marx, desde la cual se pueden obtener una buena cantidad de interpretaciones sobre el poder. Por lo que sería positivo también, desde este, establecer y delimitar algunos elementos para reflexionar sobre el poder.
